##These 2 functions create a special object that stores a matrix and caches it's
##inverse. 
...
##This function calculatest the inverse of the special matrix created by the 
